    ...
    <div className="flex items-center justify-between gap-4 py-3.5 first:pt-0 last:pb-0">
      ...
      <button
        ...
        /* The switch is drawn at 28px because a 44px pill would look like a
           button, but it must still be a 44px target. The pseudo-element is an
           invisible hit area centred over the same box: the control keeps its
           proportions and the thumb gets the whole 44px. */
        className={`relative h-7 w-12 shrink-0 cursor-pointer rounded-full border transition-colors duration-200 ease-out before:absolute before:left-1/2 before:top-1/2 before:h-11 before:w-full before:-translate-x-1/2 before:-translate-y-1/2 before:content-[''] disabled:cursor-not-allowed disabled:opacity-50 ${
          checked
