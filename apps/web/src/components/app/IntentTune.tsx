  ...
  return (
    <>
      <button
         ...
         */
        className="nf-tap grid size-8 place-items-center rounded-[var(--nf-radius-pill)] bg-black/45 text-white backdrop-blur-sm transition-transform active:scale-[0.92] motion-reduce:transition-none"
      >
